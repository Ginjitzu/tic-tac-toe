...
public class GameStateManager : NetworkManager {
    ...
    //public GameObject shared_canvas;
    ...
    public override void OnServerAddPlayer(NetworkConnection conn)
    {
        ...
        if (NetworkServer.connections.Count == this.maxConnections)
        {
            ...
            GameObject thing = Instantiate(spawnPrefabs.Find(prefab => prefab.name == "Thing"));
            NetworkServer.Spawn(thing);
            // How TF do I make a client do something from here?
        }
    }
